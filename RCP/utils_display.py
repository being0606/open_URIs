...
class DisplayFace:
    def __init__(self, draw3d=False, intrin=None, max_num_faces=1,
        ...
        if draw3d:
            ...
            self.mesh = o3d.io.read_triangle_mesh('./data/canonical_face_model.pzly')
...
class DisplayHand:
    ...
    def draw_joint_angle(self, img, p):
        ...
        elif p['gesture']=='Forearm Neutral2' or \
             p['gesture']=='Forearm Pronation2' or \
             p['gesture']=='Forearm Supination2' or \
